...
require (
	...
	github.com/netfoundry/ziti-edge v0.13.19
	github.com/netfoundry/ziti-fabric v0.11.24
	github.com/netfoundry/ziti-foundation v0.9.13
	github.com/netfoundry/ziti-sdk-golang v0.11.25
